...
pub struct MysekaifixtureElement {
    ...
    pub mysekai_fixture_sub_genre_id:Option< Option<i64>>,
    ...
    pub mysekai_fixture_footstep_id:Option< Option<i64>>,
    ...
    pub first_put_cost:Option< Option<i64>>,

    pub second_put_cost:Option< Option<i64>>,

    pub color_code:Option< Option<String>>,

    pub mysekai_fixture_game_character_group_performance_bonus_id:Option< Option<i64>>,
}
...
pub struct MysekaiFixtureTagGroup {
    ...
    pub mysekai_fixture_tag_id2:Option< Option<i64>>,

    pub mysekai_fixture_tag_id3:Option< Option<i64>>,

    pub mysekai_fixture_tag_id4:Option< Option<i64>>,
}

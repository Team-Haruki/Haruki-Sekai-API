...
pub struct MusicElement {
    ...
    pub live_talk_background_assetbundle_name:Option< Option<LiveTalkBackgroundAssetbundleName>>,

    pub published_at: Option<i64>,

    pub released_at: Option<i64>,

    pub live_stage_id:Option< Option<i64>>,
    ...
    pub music_collaboration_id:Option< Option<i64>>,

    pub infos:Option< Option<Vec<Info>>>,
}

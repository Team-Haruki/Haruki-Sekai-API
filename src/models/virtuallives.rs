...
pub struct VirtualliveElement {
    ...
    pub screen_mv_music_vocal_id:Option< Option<i64>>,
    ...
    pub virtual_live_cheer_point_rewards:Option< Option<Vec<Option<serde_json::Value>>>>,
    ...
    pub archive_release_condition_id:Option< Option<i64>>,

    pub sub_game_character_penlight_color_group_id:Option< Option<i64>>,

    pub virtual_live_group_id:Option< Option<i64>>,
}
...
pub struct VirtualItem {
    ...
    pub virtual_item_label_type:Option< Option<VirtualItemLabelType>>,

    pub sub_game_character_id:Option< Option<i64>>,
}
...
pub struct VirtualLiveCharacter {
    ...
    pub sub_game_character2_d_id:Option< Option<i64>>,
}
...
pub struct VirtualLiveSchedule {
    ...
    pub notice_group_id:Option< Option<NoticeGroupId>>,
}
...
pub struct VirtualLiveSetlist {
    ...
    pub virtual_live_stage_id:Option< Option<i64>>,

    pub music_id:Option< Option<i64>>,

    pub music_vocal_id:Option< Option<i64>>,

    #[serde(rename = "character3dId1")]
    pub character3_d_id1:Option< Option<i64>>,

    #[serde(rename = "character3dId2")]
    pub character3_d_id2:Option< Option<i64>>,

    #[serde(rename = "character3dId3")]
    pub character3_d_id3:Option< Option<i64>>,

    #[serde(rename = "character3dId4")]
    pub character3_d_id4:Option< Option<i64>>,

    #[serde(rename = "character3dId5")]
    pub character3_d_id5:Option< Option<i64>>,

    #[serde(rename = "character3dId6")]
    pub character3_d_id6:Option< Option<i64>>,
}
...
pub struct VirtualLiveWaitingRoom {
    ...
    pub assetbundle_name:Option< Option<AssetbundleName>>,

    pub start_at: Option<i64>,

    pub end_at: Option<i64>,

    pub lobby_assetbundle_name:Option< Option<LobbyAssetbundleName>>,
}

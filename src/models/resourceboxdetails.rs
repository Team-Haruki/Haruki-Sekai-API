...
//
// use generated_module::Resourceboxdetail;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: Resourceboxdetail = serde_json::from_str(&json).unwrap();
// }

use serde::{Deserialize, Serialize};

pub type Resourceboxdetail = Vec<ResourceboxdetailElement>;

#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct ResourceboxdetailElement {
...
pub enum ResourceBoxPurpose {
    ...
    #[serde(rename = "live_mission_pass")]
    LiveMissionPass,
...
pub enum ResourceType {
    ...
    #[serde(rename = "mysekai_music_record")]
    MysekaiMusicRecord,

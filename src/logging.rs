...
fn component_color(component: &str) -> &'static str {
    match component {
        ...
        "api" | "routes" | "handlers" => COLOR_GREEN,
        "client" | "sekai_client" => COLOR_BRIGHT_BLUE,
        "updater" | "scheduler" => COLOR_MAGENTA,
        "db" | "database" => COLOR_BLUE,
        "ingest" => COLOR_CYAN,
        "crypto" => COLOR_YELLOW,
        "models" | "config" => COLOR_BRIGHT_MAGENTA,
        _ => COLOR_BRIGHT_CYAN,
    }
}
